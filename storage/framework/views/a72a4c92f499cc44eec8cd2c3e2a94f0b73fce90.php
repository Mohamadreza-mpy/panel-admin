    ...
    <div class="card mb-5 mb-xl-8">
        ...
        <div class="card-header border-0 pt-5">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label fw-bold fs-3 mb-1">مقالات</span>
            </h3>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex justify-content-end flex-shrink-0">
                                        ...
                                        <a onclick="fire('<?php echo e($article->id); ?>', '<?php echo e($article->title); ?>')" href="#" class="btn btn-icon btn-bg-light btn-active-color-danger btn-sm">
...
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\sample\panel-admin\resources\views/admin/article/index.blade.php ENDPATH**/ ?>