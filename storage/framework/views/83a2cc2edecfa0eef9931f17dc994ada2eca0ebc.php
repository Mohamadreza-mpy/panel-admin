    ...
    <div class="app-container container-fluid d-flex align-items-stretch justify-content-between"
        ...
        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
            <a href="" class="d-lg-none">
                <img alt="Logo" src="<?php echo e(asset('assets/images/logo.png')); ?>" class="h-30px" />
            </a>
        </div>
        <!--end::Mobile logo-->
                        ...
                        <div class="menu-item px-3">
                            <div class="menu-content d-flex align-items-center px-3">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <a href="#"
                                        class="fw-semibold text-muted text-hover-primary fs-7">enail</a>
                                </div>
                                <!--end::Username-->
                            </div>
                        </div>
...
<?php /**PATH D:\sample\panel-admin\resources\views/layouts/admin/blocks/header.blade.php ENDPATH**/ ?>