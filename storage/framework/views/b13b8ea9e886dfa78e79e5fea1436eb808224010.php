            ...
            <div class="box-body">
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-6">
                            <label>عنوان:</label>
                            <input class="form-control" type="text" id="name" name="title" value="<?php if(isset($data->name)): ?> <?php echo e($data->name); ?> <?php endif; ?>" placeholder="عنوان  را وارد کنید . . .">
                        </div>
...
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\sample\panel-admin\resources\views/admin/role/create.blade.php ENDPATH**/ ?>