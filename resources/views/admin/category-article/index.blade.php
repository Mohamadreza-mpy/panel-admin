    ...
    <div class="card mb-5 mb-xl-8">
        ...
        <div class="card-header border-0 pt-5">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label fw-bold fs-3 mb-1">دسته بندی مقالات</span>
            </h3>
            <div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover"
                data-kt-initialized="1">
                <a href="{{ url('admin/categoryarticles/create') }}" class="btn btn-sm btn-light btn-active-info">
                    ...
                    اضافه کردن دسته بندی مقاله جدید
                </a>
            </div>
        </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex justify-content-end flex-shrink-0">
                                        ...
                                        <a href="{{ url('admin/categoryarticles/edit/'.$category->id) }}"
        ...
        function fire(id, title) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location = "{{ url('admin/categoryarticles/delete') }}/" + id
                }
            })
        }
    </script>
