...
<div class="menu-item">
    <a class="menu-link" href="#">
        ...
        <span class="menu-title">دپارتمان ها</span>
    </a>
</div>
...
<div class="menu-item">
    <a class="menu-link" href="#">
        ...
        <span class="menu-title">مشاورین</span>
    </a>
</div>
<div class="menu-item">
    <a class="menu-link" href="#">
...
{{--    $persain_date =App\Library\Helper::persian2LatinDigit(jdate('m',@$date->timestamp));--}}
{{--    if($persain_date != '10')--}}
{{--    {--}}
{{--        $month = str_replace('0',"",$persain_date);--}}
{{--    }else {--}}
{{--        $month = $persain_date;--}}
{{--    } --}}
{{--@endphp--}}
<div class="menu-item">
    <a class="menu-link" href=#">
        ...
        <span class="menu-title">فاکتور های نوبت دهی</span>
...
<div class="menu-item">
    <a class="menu-link" href="#">
        ...
        <span class="menu-title">تقویم نوبت دهی</span>
...
<div class="menu-item">
    <a class="menu-link" href="">
        ...
        <span class="menu-title">جدول نوبت دهی</span>
...
<div class="menu-item">
    ...
    <span class="menu-icon">
        <span class="svg-icon svg-icon-2 mx-2">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-chat-left-quote-fill" viewBox="0 0 16 16">
        ...
        <span class="menu-title">درخواست رزرو مشاوره</span>
        <span class="menu-badge">
{{--            @php--}}
{{--                $count_req_1 = App\Models\RequestConsultant::where('status', '0')->count();--}}
{{--            @endphp--}}
            <span class="badge badge-info">1</span>
        </span>
    </a>
...
<div class="menu-item">
    ...
    <span class="menu-icon">
        ...
        <span class="menu-title">درخواست خرید دوره</span>
        <span class="menu-badge">
{{--            @php--}}
{{--                $count_req_2 = App\Models\RequestCourse::where('status', '0')->count();--}}
{{--                --}}
{{--            @endphp--}}
...
<div class="menu-item">
    ...
    <span class="menu-icon">
        ...
        <span class="menu-title">درخواست رزرو مشاوره کودکان</span>
        <span class="menu-badge">
{{--            @php--}}
{{--                $count_req_2 = App\Models\Landing::count();--}}
{{--                --}}
{{--            @endphp--}}
            <span class="badge badge-info">1</span>
        </span>
...
<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
    ...
    <span class="menu-link">
        ...
        <span class="menu-badge">
{{--            @php--}}
{{--                $count = App\Models\Commant::where('commantable_type', 'App\Models\Article')->where('status', 'pending')->count();--}}
{{--                $count2 = App\Models\Commant::where('commantable_type', 'App\Models\Service')->where('status', 'pending')->count();--}}
{{--                $count3 = App\Models\Commant::where('commantable_type', 'App\Models\Course')->where('status', 'pending')->count();--}}
{{--                $count4 = App\Models\Commant::where('commantable_type', 'App\Models\Consultant')->where('status', 'pending')->count();--}}
    ...
    <div class="menu-sub menu-sub-accordion" kt-hidden-height="242" style="display: none; overflow: hidden;">
        ...
        <div class="menu-item">
            <a class="menu-link" href="#">
                ...
                <span class="menu-title">کامنت مقالات</span>
                <span class="menu-badge">
{{--                    @php--}}
{{--                        $count = App\Models\Commant::where('commantable_type', 'App\Models\Article')->where('status', 'pending')->count();--}}
{{--                    @endphp--}}
        ...
        <div class="menu-item">
            <a class="menu-link" href="#">
                ...
                <span class="menu-title">کامنت خدمات</span>
                <span class="menu-badge">
{{--                    @php--}}
{{--                        $count2 = App\Models\Commant::where('commantable_type', 'App\Models\Service')->where('status', 'pending')->count();--}}
{{--                    @endphp--}}
{{--                    --}}
        ...
        <div class="menu-item">
            <a class="menu-link" href="#">
                ...
                <span class="menu-title">کامنت دوره ها</span>
                <span class="menu-badge">
{{--                    @php--}}
{{--                        $count3 = App\Models\Commant::where('commantable_type', 'App\Models\Course')->where('status', 'pending')->count();--}}
{{--                    @endphp--}}
        ...
        <div class="menu-item">
            <a class="menu-link" href="#">
                ...
                <span class="menu-title">کامنت مشاوره ها</span>
                <span class="menu-badge">
{{--                    @php--}}
{{--                        $count4 = App\Models\Commant::where('commantable_type', 'App\Models\Consultant')->where('status', 'pending')->count();--}}
{{--                    @endphp--}}
...
<div class="menu-item">
    <a class="menu-link" href="#">
        ...
        <span class="menu-title">ادمین ها</span>
    </a>
</div>
